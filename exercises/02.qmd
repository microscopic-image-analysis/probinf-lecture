...
class LCG:
    ...
    def uniform(self, size):
        ...
        # don't ever do this except for demonstrating that it's bad 🙃
...
The first of the diehard tests is called **"Birtday spacings"** (named after the [birthday problem](https://en.wikipedia.org/wiki/Birthday_problem)).
